...
export const GLOSSARY = [
  ...
  { id: 'merkle-root', term: 'Merkle Root', tier: 'Intermediate', definition: 'The single hash at the top of a Merkle tree, stored in the block header — a fingerprint committing to every transaction beneath it.' },
  { id: 'light-client', term: 'Light Client', tier: 'Intermediate', definition: 'Wallet software that stores only block headers and verifies specific payments via Merkle proofs from full nodes — how phone wallets participate without the full chain.' },
  { id: 'fork', term: 'Fork', tier: 'Beginner', definition: 'A split in the chain: accidental (two valid blocks at once, healed by fork choice) or deliberate (a rule change — soft fork or hard fork).' },
